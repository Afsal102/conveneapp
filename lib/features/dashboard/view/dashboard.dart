...
class _DashBoardBody extends ConsumerWidget {
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, index) {
                              ...
                              return GestureDetector(
                                ...
                                onTap: () async {
                                  final selectedClub = await _getClub(ref, club);
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, index) {
                            ...
                            return GestureDetector(
                              ...
                              onTap: () async {
                                final selectedClub =
                                    await ref.read(currentClubsController.notifier).getClub(clubId: club.id);
  ...
  Future<ClubModel> _getClub(WidgetRef ref, PersonalClubModel club) {
    return ref.read(currentClubsController.notifier).getClub(clubId: club.id);
  }
}
