...
class ClubInfoEditView extends ConsumerStatefulWidget {
  const ClubInfoEditView({
    Key? key,
  }) : super(key: key);

  static MaterialPageRoute<dynamic> route() => MaterialPageRoute(
        builder: (context) => const ClubInfoEditView(),
      );

  @override
  _ClubInfoEditViewState createState() => _ClubInfoEditViewState();
}

class _ClubInfoEditViewState extends ConsumerState<ClubInfoEditView> {
